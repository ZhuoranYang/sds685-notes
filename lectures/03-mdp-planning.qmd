...
::: {#thm-fundamental}
## Fundamental Theorem of MDPs

1. It suffices to focus on **memoryless (Markov)** policies.
2. $\pi^*$ is greedy with respect to $V^*(Q^*)$. Moreover, $V^*(Q^*)$ is the unique solution to the Bellman equation.
:::
