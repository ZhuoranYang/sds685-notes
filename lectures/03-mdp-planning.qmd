...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ZhuoranYang/sds685-notes/blob/main/notebooks/03-planning-algorithms.ipynb) A companion notebook accompanies this chapter with runnable implementations of value iteration (V and Q versions) and linear programming on the Frozen Lake environment.
